      ...
      <div class="main-left">
        <div class="list-left">
          <ul class="list-ul-left">
            <li class="list-li-left" v-for="(categroy,index) in categroys" :key="categroy.id"
                @click="leftLiIndex(index)" :class="{on:currentIndex===index}">
              {{categroy.name}}
            </li>
          </ul>
        </div>
      ...
      <div class="main-right">
        ...
        <div>
          <div class="right-list">
            <div class="gundong">
              <div class="right-wrap" v-if="categroys[currentIndex]">
                <ul class="list-ul" v-if="(categroys[currentIndex].type === 1)" >
                  <li class="list-li" v-for="(shop,index) in categroys[currentIndex].subCateList" :key="shop.id">
                    <a href="#" class="list-a">
                      <div class="li-img">
                ...
                <div class="list-different" v-else>
                  <div class="single-dif" v-for="(subCate,index) in categroys[currentIndex].subCateList" :key="subCate.id">
                    <div class="diff-text">
                      {{subCate.name}}
                    </div>
